...
export default function Keypad() {
  ...
  return (
    <View style={styles.buttonContainer}>
        ...
        <MyButton onPress={handleClear} text="C" isOperatorButton isOperatorTextButton></MyButton>
            <MyButton onPress={() => handleOperatorInput('^')} text="xⁿ" isOperatorButton isOperatorTextButton></MyButton>
